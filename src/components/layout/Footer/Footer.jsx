  ...
  return (
    <footer className="footer">
        ...
        <div className="footer__content">
          ...
          <div className="footer__column">
            ...
            <ul id="dropdown-2" className={`${isDropdownClicked.second ? "" : "hidden"}`}>
              ...
              <li>
                <Link to="/sposoby-platnosci">Sposoby płatności</Link>
              </li>
              <li>
          ...
          <div className="footer__column">
            ...
            <ul
              id="dropdown-3"
              className={`footer__socials ${isDropdownClicked.third ? "" : "hidden"}`}
            >
              <li>
      ...
      <div className="footer__copyright">
        {"Pedal & Plate - wszelkie prawa zastrzeżone "} &copy; {currentYear}
      </div>
    </footer>
  );
}
