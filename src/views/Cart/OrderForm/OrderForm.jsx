  ...
  return (
    <form className="order-form" onSubmit={handleSubmit((data) => prepareOrder(data))}>
          ...
          <div className="form-group">
            ...
            <div className="form-element">
              <FormInput
                ...
                defaultValue={formValues.house_number}
              />
            </div>
          </div>
          <div className="form-group">
            <div className="form-element">
              <FormInput
                ...
                defaultValue={formValues.post_code}
              />
            </div>
            <div className="form-element">
              <FormInput
      ...
      <div className="order-form__check">
        <p>
          {
            "Twoje dane osobowe będą użyte do przetworzenia zamówienia, ułatwienia korzystania ze strony internetowej oraz innych celów opisanych w polityka prywatności."
          }
        </p>
        <FormInput
          id={"are_service_terms_approved"}
          label={"Przeczytałem/am i akceptuję regulamin *"}
          type={"checkbox"}
          register={{ ...register("are_service_terms_approved") }}
          isChecked={formValues.are_service_terms_approved}
        />
      </div>
      <div className="order-form__info">{"* pola wymagane"}</div>
